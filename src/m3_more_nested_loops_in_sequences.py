...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 273891401
    answer = largest_number(([90, 31749], [1, 2, 312749], [8092, 61894, 273891401]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 4:
    expected = None
    answer = largest_negative_number(([90, 31749], [1, 2, 312749], [8092, 61894, 273891401]))
    print('Expected and actual are:', expected, answer)
